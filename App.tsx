  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background">
      ...
      <button 
        ...
        className="fixed top-4 right-4 z-51 p-2.5 rounded-xl bg-primary text-primary-foreground lg:hidden shadow-lg shadow-primary/30 active:scale-95 transition-all"
      >
      ...
      <AnimatePresence mode="wait">
        {isSidebarOpen && (
          <motion.aside
            ...
            className="w-72 h-full border-r border-border bg-card flex flex-col z-40 fixed lg:static shadow-2xl lg:shadow-none"
          >
            <div className="p-6">
              <h1 className="text-xl font-bold flex items-center gap-2">
                <span className="w-8 h-8 rounded-lg bg-primary flex items-center justify-center text-white font-mono text-sm shadow-lg shadow-primary/30">Y</span>
                YKS Mentor AI
              </h1>
            </div>
      ...
      {/* Main Content */}
      <main className="flex-1 h-full overflow-y-auto relative p-4 lg:p-8 pt-20 lg:pt-8 pb-32 lg:pb-16 custom-scrollbar">
        <AnimatePresence mode="wait">
          <motion.div
            key={activeView}
